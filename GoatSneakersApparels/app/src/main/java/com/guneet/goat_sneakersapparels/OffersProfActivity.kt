...
class OffersProfActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.offer_prof)  // Layout file for OffersProfActivity

        // Initialize back arrow for navigating back
